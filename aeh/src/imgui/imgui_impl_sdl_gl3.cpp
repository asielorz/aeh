...
//  2017-05-01: OpenGL: Fixed save and restore of current gl::ACTIVE_TEXTURE.
//  2016-10-15: Misc: Added a void* user_data parameter to Clipboard function handlers.
//  2016-09-05: OpenGL: Fixed save and restore of current scissor rectangle.
//  2016-07-29: OpenGL: Explicitly setting gl::UNPACK_ROW_LENGTH to reduce issues because SDL changes it. (#752)
...
namespace ImGui
{
	namespace SDL
	{
		...
		bool CreateDeviceObjects(Renderer & renderer)
		{
			...
			ImGui::SDL::CreateFontsTexture(renderer);
		...
		bool Init(Renderer & renderer, SDL_Window * window, const char* glsl_version)
		{
			...
			io.SetClipboardTextFn = ImGui::SDL::SetClipboardText;
			io.GetClipboardTextFn = ImGui::SDL::GetClipboardText;
		...
		void Shutdown(Renderer & renderer)
		{
			...
			ImGui::SDL::InvalidateDeviceObjects(renderer);
		}

		void NewFrame(Renderer & renderer, SDL_Window * window)
		{
			if (!renderer.FontTexture)
				ImGui::SDL::CreateDeviceObjects(renderer);
